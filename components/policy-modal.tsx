...
const POLICIES: Record<PolicyKey, Policy> = {
  shipping: {
    title: 'Shipping',
    subtitle: 'Shipping Policy – Lavish Notes',
    blocks: [
      { type: 'lead', text: 'At Lavish Notes, we aim to process and ship all orders as quickly and efficiently as possible.' },
      ...
      { type: 'paragraph', text: 'While we ensure that all orders are shipped on time, Lavish Notes is not responsible for delays, lost packages, or delivery issues caused by the shipping carrier after the package has been handed over and accepted by the courier.' },
      ...
      { type: 'paragraph', text: 'Customers are responsible for providing accurate shipping details at checkout. Lavish Notes is not responsible for orders shipped to incorrectly entered addresses.' },
      ...
      { type: 'paragraph', text: 'email: support@lavishnotes.com\nemail: lavishnotes.com@gmail.com\nPhone: +1 213 581 8266' },
    ],
  },
  faq: {
    title: 'FAQ',
    subtitle: 'FAQs – Lavish Notes',
    blocks: [
      ...
      { type: 'qa', q: 'Can I change my shipping address after placing an order?', a: 'Please contact us immediately at support@lavishnotes.com. If the order hasn’t been processed yet, we will do our best to update it for you.' },
      ...
      { type: 'qa', q: 'How can I contact you?', a: 'You can reach our support team any time at support@lavishnotes.com and we will get back to you as soon as possible.' },
    ],
  },
  privacy: {
    title: 'Privacy Policy',
    subtitle: 'Privacy Policy – Lavish Notes',
    blocks: [
      { type: 'lead', text: 'At Lavish Notes, we value your privacy and are committed to protecting your personal information. This policy outlines how we collect, use, and safeguard your data when you visit our store.' },
      ...
      { type: 'bullet', label: 'How do I withdraw my consent?', text: 'You may withdraw your consent at any time by contacting us at support@lavishnotes.com.' },
