  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 md:px-8">
      <div className="text-center">
        <p className="text-sm uppercase tracking-[0.2em] text-muted-foreground">Select Your Brand Fragrance</p>
        <h2 className="mt-3 text-4xl font-medium text-foreground md:text-5xl">Shop by Collection</h2>
        <p className="mx-auto mt-4 max-w-2xl text-pretty text-muted-foreground">
          Showing Creed by default — use the button below to browse any other house.
        </p>
      </div>

      {/* Selected brand + dropdown to pick any brand */}
      <div className="mt-8 flex flex-col items-center gap-3">
        ...
        {/* Badge showing which brand the customer selected */}
